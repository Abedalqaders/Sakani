...
namespace Api.Controllers
{
    ...
    public class MaintenanceTicketsController : ControllerBase
    {
        ...
        public async Task<ActionResult<TicketResponseDto>> GetById(Guid id, CancellationToken ct)
        {
            ...
            if (ticket == null)
            {
                return NotFound($"Ticket with ID {id} was not found or access is denied.");
            }
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult> Update(Guid id, [FromBody] UpdateTicketDto dto, CancellationToken ct)
        {
            if (id != dto.Id)
            {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult> UpdateStatus([FromBody] UpdateTicketStatusDto dto, CancellationToken ct)
        {
